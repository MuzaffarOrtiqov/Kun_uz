...
public class CategoryService {
    ...
    public CategoryDTO getCategory(Integer categoryId, LanguageEnum lang) {
        CategoryEntity entity = get(categoryId);
        entity.setId(categoryId);
        switch (lang){
            case EN -> entity.setNameEn(entity.getNameEn());
            case RU -> entity.setNameRu(entity.getNameRu());
            default -> entity.setNameUz(entity.getNameUz());
        }
        return toDto(entity);
    }
}
